...
export default function HowICanHelp() {
  ...
  return (
    <section id="services" className="editorial-section">
      <SectionHeader kicker="How I can help" title="Where I can make an immediate difference."
      ...
      <div className="capability-layout">
        <div className="capability-list" role="tablist" aria-label="Capabilities">
          {SERVICES.map(([name], index) => (
            <button key={name} type="button" role="tab" aria-selected={active === index} onClick={() => setActive(index)}>
